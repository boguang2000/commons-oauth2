...
import static com.sgitg.app.core.oauth2.altu.oauth2.rs.ResourceServer.getQueryParameterValues;
...
public class BearerQueryOAuthValidator extends AbstractValidator<HttpServletRequest> {
    ...
    public void validateRequiredParameters(HttpServletRequest request) throws OAuthProblemException {
        ...
        if (OAuthUtils.hasEmptyValues(tokens)) {
            ...
            if (OAuthUtils.hasEmptyValues(tokens)) {
                throw OAuthProblemException.error(OAuthError.ResourceResponse.INVALID_REQUEST, "Missing OAuth token.");
            }
        }
