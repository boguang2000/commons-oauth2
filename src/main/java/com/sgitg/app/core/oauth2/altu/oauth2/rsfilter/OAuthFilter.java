...
import com.sgitg.app.core.oauth2.altu.oauth2.common.message.OAuthResponse;
import com.sgitg.app.core.oauth2.altu.oauth2.common.message.types.ParameterStyle;
import com.sgitg.app.core.oauth2.altu.oauth2.rs.request.OAuthAccessResourceRequest;
import com.sgitg.app.core.oauth2.altu.oauth2.rs.response.OAuthRSResponse;
...
public class OAuthFilter implements Filter {
        ...
        if (OAuthUtils.isEmpty(parameterStylesString)) {
            ...
            if (parameters != null && parameters.length > 0) {
                ...
                for (int i = 0; i < parameters.length; i++) {
                    parameterStyles[i] = ParameterStyle.valueOf(parameters[i]);
                }
            }
        }
    ...
    private void respondWithError(HttpServletResponse resp, OAuthProblemException error)
        ...
        try {
            ...
            HttpServletUtil.sendError(resp, oauthResponse.getResponseStatus());
