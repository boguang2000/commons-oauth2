...
import com.sgitg.app.core.oauth2.altu.oauth2.as.validator.UnauthenticatedAuthorizationCodeValidator;
import com.sgitg.app.core.oauth2.altu.oauth2.as.validator.UnauthenticatedPasswordValidator;
import com.sgitg.app.core.oauth2.altu.oauth2.as.validator.UnauthenticatedRefreshTokenValidator;
...
public class OAuthUnauthenticatedTokenRequest extends AbstractOAuthTokenRequest {
    ...
    protected OAuthValidator<HttpServletRequest> initValidator() throws OAuthProblemException, OAuthSystemException {
        validators.put(GrantType.AUTHKEY.toString(), UnauthenticatedPasswordValidator.class);
