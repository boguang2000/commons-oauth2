...
package com.sgitg.app.core.oauth2.altu.oauth2.as.request;

import com.sgitg.app.core.oauth2.altu.oauth2.as.validator.AuthorizationCodeValidator;
import com.sgitg.app.core.oauth2.altu.oauth2.as.validator.ClientCredentialValidator;
import com.sgitg.app.core.oauth2.altu.oauth2.as.validator.PasswordValidator;
import com.sgitg.app.core.oauth2.altu.oauth2.as.validator.RefreshTokenValidator;
...
import com.sgitg.app.core.oauth2.altu.oauth2.common.message.types.GrantType;
import com.sgitg.app.core.oauth2.altu.oauth2.common.validators.OAuthValidator;
...
public class OAuthTokenRequest extends AbstractOAuthTokenRequest {
    ...
    protected OAuthValidator<HttpServletRequest> initValidator() throws OAuthProblemException, OAuthSystemException {
        validators.put(GrantType.AUTHKEY.toString(), PasswordValidator.class);
        ...
        validators.put(GrantType.AUTHKEY_DOUBLE.toString(), PasswordValidator.class);
