...
package com.sgitg.app.core.oauth2.altu.oauth2.common;

import com.sgitg.app.core.oauth2.altu.oauth2.common.message.types.ParameterStyle;
import com.sgitg.app.core.oauth2.altu.oauth2.common.message.types.TokenType;
...
public final class OAuth {
    ...
    /**
     * 通过Cookie传递访问令牌字符串，一般用于传统业务系统，不用于登录授权本身。
     * 
     * @author xkxu
     */
    public static final class Cookie {
    	
    	public static final String COOKIE_NAME = OAUTH_ACCESS_TOKEN;
    }
    ...
    public static final String OAUTH_AUTHKEY = "password";
    ...
    public static final String OAUTH_TICKET = "ticket";
    public static final String OAUTH_TYPE_TOKEN = "token";
    ...
    public static final String[] CUSTOM_LOGIN_SUCCESS_URL = new String[] {"/x-ac-loginSuccess","/x-ac-wxlogin", "/x-ac-wxqrloginSuccess"};
}
